...
-- Tempo de Geração: Nov 02, 2010 as 02:44 PM
...
(7, '2010-10-03', 'Depois da Guerra', 'http://2.bp.blogspot.com/_tRyYzw3AhCo/SfZ2_7jSOHI/AAAAAAAAAAc/sCGA1xrStoU/s400/Oficina-G3-CD-Depois-da-Guerra.jpg', 'Último cd do Oficina G3', 2, 0, NULL, NULL, 1, 0, NULL, NULL),
...
(10, '2010-11-02', 'Todo garoto Tem', 'http://imagens.travessa.com.br/livro/DT/9d/9d31521d-0365-4ad5-8d1e-b83479eca82c.jpg', 'Essa era uma viagem que tinha tudo para dar certo: Holly e Mark decidem fugir para se casar numa villa do interior da Itália, tentando evitar o stress causado pela diferença de religião entre suas famílias. Para acompanhá-los como madrinha, dama de honra e melhor amiga da noiva, a cartunista Jane Harris, uma mulher divertida e engraçada que mal pode esperar pela sua primeira viagem ao exterior. Mas é claro que Mark também convidou o seu melhor amigo, o jornalista internacional Cal Langdon. Já no aeroporto, Jane e Cal sofrem de total ódio à primeira vista. Mas o que ninguém esperava era que somente esses dois pudessem salvar o casamento de seus melhores amigos. E, nessa inesperada união entre opostos, Cal e Jane acabam por descobrir que, mesmo que não pareça, existe algo que todo garoto tem.', 1, 1, NULL, NULL, 2, NULL, NULL, NULL);
...
(1, 1, 2, '2010-11-01', 924, 'Era pra ter lançado ontem, mas ficou pra hoje! Você pode ganhar um exemplar de Cem Toques Cravados, o livro de Edson Rossatto que contém cem nanocontos para serem lidos em qualquer lugar.'),
(2, 2, 1, '2010-11-10', 924, 'A Triologia de filmes Deixados para Trás, alcançou grande sucesso pelo mundo, sendo vendidos mais de 10 milhões de cópias. A nova produção que ocorrerá em 2011 será um "remake" do Deixados para trás, e a Cloud Ten Pictures promete um orçamento '),
(3, 1, 2, '2010-11-01', 924, 'Teste de nova mensagem'),
(4, 1, 2, '2010-11-01', 278, 'Mias um teste. Troca com zero mensagens.'),
(5, 1, 2, '2010-11-02', 924, 'Vamos marcar no hall do 6º andar, ok?'),
(6, 1, 2, '2010-11-02', 927, 'Me interessei pelo seu livro Cidade dos Ossos. Está em bom estado? Ofereço em troca esse clássico da literatura, semi-novo, comprado em dezembro de 2009. Topa?');
